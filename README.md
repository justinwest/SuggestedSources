# AI Response Generator with Deep Research
...
* Leverage Deep Research capabilities from Claude 4 and ChatGPT o3

**Changelog:**
* 29-JUN-2025: Claude now has web search enabled by default for all requests
* 29-JUN-2025: Added Grok web search support for live information retrieval
* 28-JUN-2025: Added Claude Deep Research support (tool availability depends on API access)
...
- **Claude Web Search**: All Claude requests now have web search and web fetch tools enabled by default
- **Claude Deep Research**: Claude 4 models have enhanced multi-source research capabilities
- **ChatGPT o3-deep-research**: Advanced research model that performs extensive multi-step research (expensive, rate-limited)
- **Grok Web Search**: Grok 2 and Grok 3 models use live web search for current information retrieval
- **Extended Timeouts**: Longer timeouts for complex research tasks
- **Research Statistics**: Detailed logging of searches performed and sources analyzed
