# AI Response Generator with User Suggested Sources
...
- **Multi-Model Comparison**: Compare responses from Claude, ChatGPT, Gemini, and Grok
- **Source Integration**: See how providing sources affects AI responses
- **ChatGPT o3-deep-research**: Advanced research model that performs extensive multi-step research (expensive, rate-limited)
- **Grok Web Search**: Grok 2 and Grok 3 models can use live web search (configure in config.json)
- **Automatic Updates**: Responses regenerate when source files change

### Tool Configuration

To enable tools like web search for supported models, edit the `tools` section in your `config.json` file. Example:
